...
export let pastSponsors = [
	...
	{ name: "We Rock The Spectrum Kid's Gym", logoUrl: '/we-rock-the-spectrum-logo.png', linkUrl: 'https://werockthespectrumforesthill.com/', class: 'scale-110 !rounded-lg' },
	...
	{
		name: 'Panera Bread',
		logoUrl: '/panera-bread-logo.svg',
		linkUrl: 'https://www.panerabread.com/content/panerabread_com/en-us/cafe/locations/md/bel-air/5-bel-air-south-parkway',
		class: '!rounded-none',
	},
